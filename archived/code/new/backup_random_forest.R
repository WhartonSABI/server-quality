...
path_oos_u_m_scaled   <- "../data/output/scaled-results/usopen_m_test_scaled.csv"
path_oos_u_f_scaled   <- "../data/output/scaled-results/usopen_f_test_scaled.csv"
# 
...
## -------- 0.  FILE LOCATIONS -------------------------------------------
paths <- list(
  wimbledon_m = "../data/output/scaled-results/wimbledon_m_train_scaled.csv",  # 2021-24
  wimbledon_f = "../data/output/scaled-results/wimbledon_f_train_scaled.csv",
  usopen_m    = "../data/output/scaled-results/usopen_m_train_scaled.csv",
  usopen_f    = "../data/output/scaled-results/usopen_f_train_scaled.csv"
)
