...
write.csv(subset_2021_m, "../data/output/wimbledon_subset_2021_m.csv", row.names = FALSE)
write.csv(subset_2021_f, "../data/output/wimbledon_subset_2021_f.csv", row.names = FALSE)
