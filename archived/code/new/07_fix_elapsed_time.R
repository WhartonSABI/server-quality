...
write.csv(subset_m, "../data/output/wimbledon_subset_m.csv", row.names = FALSE)
...
write.csv(subset_f, "../data/output/wimbledon_subset_f.csv", row.names = FALSE)
...
write.csv(subset_m, "../data/output/scaled-results/wimbledon_m_train_scaled.csv", row.names = FALSE)
write.csv(subset_f, "../data/output/scaled-results/wimbledon_f_train_scaled.csv", row.names = FALSE)
